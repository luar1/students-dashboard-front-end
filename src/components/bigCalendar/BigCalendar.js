...
class BigCalendar extends Component {
    ...
    constructor() {
        ...
        const events = [
...

            {
                id: 2,
                title: "DTS STARTS",
                start: new Date(2020, 10, 13, 0, 0, 0),
                end: new Date(2020, 10, 20, 0, 0, 0),
            },
            ...
            },
            {
                ...
                end: new Date(2020, 3, 10, 15, 0, 0, 0),
            },
            {
                id: 9,
                title: "Happy Hour",
    ...
    render() {
        const highlightedDate = this.context[0];
        console.log(this.context[0]._d);
